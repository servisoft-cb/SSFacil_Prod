object frmConsMatKG: TfrmConsMatKG
  Left = 181
  Top = 76
  Width = 928
  Height = 564
  Caption = 'Consulta Ordem de Produ'#231#227'o'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Material: TRzTabSheet
      ...
      object SMDBGrid1: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMLoteImp.dsConsMatKG
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Qtd Mat. Produzido'
            Title.Color = 9174807
            Width = 70
            Visible = True
          end
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Qtd. Prod. Produzido'
            Title.Color = 9174807
            Width = 88
            Visible = True
          end>
    ...
    object TS_Ref: TRzTabSheet
      Caption = 'Material Por Refer'#234'ncia'
      object SMDBGrid2: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMLoteImp.dsConsMatKG_Ref
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgMultiSelect]
        ParentCtl3D = False
        ReadOnly = True
        TabOrder = 0
  ...
  object Panel1: TPanel
    ...
    object lblNomeCliente: TNxLabel
      Left = 549
      Top = 49
      Width = 262
      Height = 13
