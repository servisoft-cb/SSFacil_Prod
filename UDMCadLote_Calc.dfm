object DMCadLote_Calc: TDMCadLote_Calc
  ...
  object sdsConsumoCalc: TSQLDataSet
    CommandText = 
      ...
      'R.NOME NOME_COR,'#13#10'    PC.ID_SETOR'#13#10'FROM PRODUTO P'#13#10'INNER JOIN PR' +
      'ODUTO_COMB PB'#13#10'ON P.id = pb.ID'#13#10'AND PB.id_cor_combinacao = :ID_C' +
      'OMBINACAO'#13#10'INNER JOIN PRODUTO_COMB_MAT PMAT'#13#10'ON PB.ID = PMAT.ID'#13 +
      #10'AND PB.ITEM = PMAT.ITEM'#13#10'INNER JOIN PRODUTO_CONSUMO PC'#13#10'ON PMAT' +
      '.id = PC.id'#13#10'AND PMAT.id_material = PC.ID_MATERIAL'#13#10'AND PMAT.id_' +
      'posicao = PC.id_posicao'#13#10'LEFT JOIN PRODUTO MAT'#13#10'ON PC.id_materia' +
      'l = MAT.id'#13#10'LEFT JOIN COMBINACAO COR'#13#10'ON PMAT.ID_COR = COR.ID'#13#10'W' +
      'HERE P.TIPO_REG = '#39'P'#39#13#10'  and p.id = :ID_PRODUTO'#13#10
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object sdsConsLote_Novo: TSQLDataSet
    ...
    CommandText = 
      ...
      'TENTREGA,'#13#10'L.qtd_taloes, L.NUM_ORDEM, L.CARIMBO, L.TALAO_AUX_GER' +
      'ADO,'#13#10'L.id_produto, L.qtd, L.qtd_pendente, L.qtd_produzido,'#13#10'L.d' +
      'tbaixa, L.hrbaixa, L.impresso, L.id_combinacao, l.id_pedido, l.i' +
      'tem_pedido,'#13#10'PRO.REFERENCIA, PRO.NOME NOME_PRODUTO, PRO.UNIDADE,' +
      ' FIL.NOME NOME_FILIAL, PRO.ID_GRADE,'#13#10'PCP.id_tipo_matriz, TM.NOM' +
