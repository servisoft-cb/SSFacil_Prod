object frmCadDocEstoqueCB: TfrmCadDocEstoqueCB
  Left = 177
  Top = 38
  Width = 945
  Height = 669
  Caption = 'Documento de Entrada no Estoque por C'#243'digo de Barras'
  Color = clBtnFace
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Cadastro: TRzTabSheet
      ...
      object RzPageControl2: TRzPageControl
        ...
        Width = 933
        Height = 470
        ActivePage = TS_CodBarra
        ActivePageDefault = TS_CodBarra
        Align = alClient
        ...
        TabOrder = 2
        FixedDimension = 19
        object TS_CodBarra: TRzTabSheet
          ...
          object SMDBGrid2: TSMDBGrid
            ...
            Align = alClient
            Ctl3D = False
            DataSource = DMCadDocEstoque.dsmAuxCodBarra
            Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
            ParentCtl3D = False
            ReadOnly = True
            TabOrder = 1
