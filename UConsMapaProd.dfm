object frmConsMapaProd: TfrmConsMapaProd
  Left = 278
  Top = 66
  Width = 971
  Height = 581
  Caption = 'frmConsMapaProd'
  Color = clBtnFace
  ...
  object pnlPesquisa: TPanel
    ...
    object NxLabel2: TNxLabel
      ...
      Height = 13
      Alignment = taRightJustify
      Caption = 'N'#186' Ordem Produ'#231#227'o Ini:'
      Transparent = False
      HorizontalPosition = hpLeft
      InnerHorizontal = True
      InnerVertical = False
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TS_Talao: TRzTabSheet
      ...
      object SMDBGrid2: TSMDBGrid
        ...
        Align = alClient
        Ctl3D = False
        DataSource = DMMapaProd.dsmMapa_Talao
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit]
        ParentCtl3D = False
        ReadOnly = True
        TabOrder = 0
    ...
    object TS_Acumulado: TRzTabSheet
      Caption = 'Acumulado'
    end
  end
end
