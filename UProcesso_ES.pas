...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if Trim(fDMBaixaProd.qFuncionarioSENHA.AsString) <> '' then
        begin
          vSenha := '';
          frmSenhaAux := TfrmSenhaAux.Create(Self);
          frmSenhaAux.vSenha_Local   := fDMBaixaProd.qFuncionarioSENHA.AsString;
          frmSenhaAux.Label2.Caption := fDMBaixaProd.qFuncionarioNOME.AsString;
          frmSenhaAux.ShowModal;
          FreeAndNil(frmSenhaAux);
          if vSenha <> fDMBaixaProd.qFuncionarioSENHA.AsString then
          begin
            CurrencyEdit2.Clear;
            CurrencyEdit2.SetFocus;
            fDMBaixaProd.qFuncionario.Close;
...
begin
  ...
  begin
    vID_MovEstoque := fDMEstoque.fnc_Gravar_Estoque(0,
                                                    ...
                                                    vLote_Controle,
                                                    vGeraCusto,
                                                    vPreco,0,0,0,0,0,0); //ver aqui sobre Lote Controle  04/11/2015
  end;
...
procedure TfrmProcesso_ES.CurrencyEdit2Enter(Sender: TObject);
begin
  fDMBaixaProd.qFuncionario.Close;
end;

procedure TfrmProcesso_ES.SpeedButton1Click(Sender: TObject);
begin
  frmAltSenhaFunc := TfrmAltSenhaFunc.Create(Self);
  frmAltSenhaFunc.fDMBaixaProd := fDMBaixaProd;
