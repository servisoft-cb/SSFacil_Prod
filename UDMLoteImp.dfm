object DMLoteImp: TDMLoteImp
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43436.447604293980000000
  ...
  object sdsConsulta_Lote: TSQLDataSet
    ...
    GetMetadata = False
    CommandText = 
      'SELECT AUX.*, AUX.REFERENCIA || '#39' '#39' || coalesce(AUX.NOME_COMBINA' +
      'CAO,'#39#39') AS ORDEM_REF,'#13#10'AUX.PEDIDO_CLIENTE || '#39' '#39' || AUX.REFERENC' +
      'IA || '#39' '#39' || coalesce(AUX.NOME_COMBINACAO,'#39#39') AS ORDEM_PED'#13#10'FROM' +
      ' ('#13#10'SELECT B.id ID_BAIXA, B.ITEM ITEM_BAIXA, B.id_processo, B.id' +
      '_lote, B.id_pedido,'#13#10'B.item_pedido, B.dtentrada, B.hrentrada,B.d' +
      'tbaixa,B.hrbaixa, B.qtd,'#13#10'B.qtd_produzido,B.num_ordem, B.tipo TI' +
      'PO, P.nome NOME_PROCESSO, B.total_horas,'#13#10'L.num_lote, B.qtd_libe' +
      'rada, B.qtd_pendente, B.AJUSTE, B.retrabalho,  PED.NUM_PEDIDO, l' +
      '.dtemissao,'#13#10'l.qtd_estoque_usada, '#13#10'case'#13#10'  when B.ajuste = '#39'S'#39' ' +
      'THEN '#39'S'#39#13#10'  ELSE '#39#39#13#10'  end DESCRICAO_AJUSTE,'#13#10'  case'#13#10'    WHEN B' +
      '.retrabalho = '#39'S'#39' then '#39'S'#39#13#10'    ELSE '#39#39#13#10'    END DESCRICAO_RETRA' +
      'BALHO,'#13#10'  CASE'#13#10'    WHEN L.id_combinacao > 0 THEN (SELECT COMB.n' +
      'ome NOME_COMBINACAO FROM COMBINACAO COMB WHERE COMB.ID = L.ID_CO' +
      'MBINACAO)'#13#10'    WHEN PI.id_cor > 0 THEN (SELECT COMB.nome NOME_CO' +
      'MBINACAO FROM COMBINACAO COMB WHERE COMB.ID = PI.id_cor)'#13#10'    EN' +
      'D NOME_COMBINACAO,'#13#10'  CASE'#13#10'    WHEN B.tipo = '#39'1'#39' THEN '#39'Semi Aca' +
      'bado'#39#13#10'    WHEN B.tipo = '#39'2'#39' THEN '#39'Lote/Tal'#227'o'#39#13#10'    WHEN B.tipo ' +
      '= '#39'5'#39' THEN '#39'Pedido'#39#13#10'    end DESC_TIPO_BAIXA,'#13#10'  CASE'#13#10'    WHEN ' +
      'B.TIPO <> '#39'5'#39' THEN L.REFERENCIA'#13#10'    WHEN B.TIPO = '#39'5'#39' THEN PI.r' +
      'eferencia'#13#10'    END REFERENCIA,'#13#10'  CASE'#13#10'    WHEN B.TIPO <> '#39'5'#39' T' +
      'HEN L.obs_ped'#13#10'    WHEN B.TIPO = '#39'5'#39' THEN '#39'<'#39'||PED.pedido_client' +
      'e||'#39'>'#39#13#10'    END PEDIDO_CLIENTE,'#13#10'  CASE'#13#10'    WHEN B.TIPO <> '#39'5'#39' ' +
      'THEN L.dtentrega'#13#10'    WHEN B.TIPO = '#39'5'#39' THEN PI.dtentrega'#13#10'    E' +
      'ND DTENTREGA,'#13#10'  CASE'#13#10'    WHEN B.TIPO <> '#39'5'#39' THEN (SELECT CLI.f' +
      'antasia NOME_CLIENTE FROM PESSOA CLI WHERE CLI.CODIGO = L.ID_CLI' +
      'ENTE)'#13#10'    WHEN B.TIPO = '#39'5'#39' THEN (SELECT CLI.fantasia NOME_CLIE' +
      'NTE FROM PESSOA CLI WHERE CLI.CODIGO = PED.ID_CLIENTE)'#13#10'    END ' +
      'NOME_CLIENTE,'#13#10'  CASE'#13#10'    WHEN B.TIPO <> '#39'5'#39' THEN L.ID_CLIENTE'#13 +
      #10'    WHEN B.TIPO = '#39'5'#39' THEN PED.ID_CLIENTE'#13#10'    END ID_CLIENTE,'#13 +
      #10'  CASE'#13#10'    WHEN B.TIPO <> '#39'5'#39' THEN L.unidade'#13#10'    WHEN B.TIPO ' +
      '= '#39'5'#39' THEN PI.unidade'#13#10'    END UNIDADE'#13#10'FROM baixa_processo B'#13#10'I' +
      'NNER JOIN PROCESSO P'#13#10'ON B.ID_PROCESSO = P.ID'#13#10'LEFT JOIN LOTE l'#13 +
      #10'ON L.id = B.id_lote'#13#10'LEFT JOIN PEDIDO_ITEM PI'#13#10'ON B.ID_PEDIDO =' +
      ' PI.ID'#13#10'AND B.ITEM_PEDIDO = PI.ITEM'#13#10'LEFT JOIN PEDIDO PED'#13#10'ON B.' +
      'ID_PEDIDO = PED.id) AUX'#13#10#13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = dmDatabase.scoDados
    Left = 160
