...
type
  TDMLoteImp = class(TDataModule)
    ...
    mAuxProcesso_Ped: TClientDataSet;
    mAuxProcesso_PedReferencia: TStringField;
    mAuxProcesso_PedNome_Produto: TStringField;
    mAuxProcesso_PedNome_Cor: TStringField;
    mAuxProcesso_PedQtd: TFloatField;
    mAuxProcesso_PedUnidade: TStringField;
    mAuxProcesso_PedNum_Ordem: TIntegerField;
    mAuxProcesso_PedNum_Lote: TIntegerField;
    mAuxProcesso_PedNum_Pedido: TIntegerField;
    mAuxProcesso_PedItem_Pedido: TIntegerField;
    mAuxProcesso_PedPedido_Cliente: TStringField;
    mAuxProcesso_PedNome_Cliente: TStringField;
    sdsProcesso_Ped: TSQLDataSet;
    dspProcesso_Ped: TDataSetProvider;
    cdsProcesso_Ped: TClientDataSet;
    dsProcesso_Ped: TDataSource;
    dsmAuxProcesso_Ped: TDataSource;
    cdsProcesso_PedQTD_PRODUCAO_PEDIDO: TFloatField;
    cdsProcesso_PedNUM_PEDIDO: TIntegerField;
    cdsProcesso_PedPEDIDO_CLIENTE: TStringField;
    cdsProcesso_PedDTENTREGA: TDateField;
    mAuxProcesso_PedID_Processo: TIntegerField;
    mAuxProcesso_PedNome_Processo: TStringField;
