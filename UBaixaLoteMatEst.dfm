object frmLoteMaterialEstoque: TfrmLoteMaterialEstoque
  Left = 424
  Top = 167
  Width = 582
  Height = 465
  ...
  object Panel1: TPanel
    ...
    object DBEdit1: TDBEdit
      ...
      Color = clSilver
      DataField = 'NUM_ORDEM'
      DataSource = DMBaixaMaterial.dsLotMatEst
      ReadOnly = True
      TabOrder = 0
    end
    ...
    object dbedtDataMov: TDBDateEdit
      Left = 67
      Top = 110
      Width = 121
      Height = 21
    ...
    object rxdblkpcmbFilial: TRxDBLookupCombo
      Left = 67
      Top = 70
      Width = 254
      Height = 21
      ...
      LookupField = 'ID'
      LookupDisplay = 'NOME'
      LookupSource = DMBaixaMaterial.dsFilial
      TabOrder = 2
    end
